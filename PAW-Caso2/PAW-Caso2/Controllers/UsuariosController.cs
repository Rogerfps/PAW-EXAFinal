...
namespace PAW_Caso2.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(EventCorpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,NombreUsuario,NombreCompleto,Correo,Telefono,Contrasena,Rol")] Usuario usuario)
        {
